...
RUN mkdir /OneDriveConf && mkdir /OneDriveData &&  mv /home/nobody/config /OneDriveConf && chown -R nobody:users /OneDriveConf && chown -R nobody:users /OneDriveData && chown -R nobody:users /home/nobody
